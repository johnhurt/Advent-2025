...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `78.4µs` | `79.1µs` |
| [Day 2](./src/bin/02.rs) | `3.3µs` | `28.4µs` |
| [Day 3](./src/bin/03.rs) | `16.9µs` | `36.4µs` |
| [Day 4](./src/bin/04.rs) | `56.0µs` | `420.5µs` |
| [Day 5](./src/bin/05.rs) | `89.8µs` | `24.4µs` |
| [Day 6](./src/bin/06.rs) | `107.8µs` | `63.4µs` |
